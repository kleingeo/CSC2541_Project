...
class Pix2Pix():
    def __init__(self,
        ...
        self.classes = 1
        self.seg_shape = (self.img_rows, self.img_cols, self.classes)
        ...
        self.disc_patch = (8, 8, self.channels)
    ...
    def train(self, epochs, sample_interval=50):
        ...
        for epoch in range(epochs):
            for i in range(batch_amt):
                ...
                # Plot the progress
                print ("[Epoch %d/%d] [Batch %d/%d] [D_real loss: %f, acc: %3d%%] [D_real loss: %f, acc: %3d%%] "
    ...
    def sample_images(self, epoch, batch_i):
        ...
        gen_imgs = np.concatenate([np.expand_dims(imgs_B[:, :, :, 0], axis=-1),
                                   fake_A, imgs_A])
