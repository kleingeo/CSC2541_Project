...
2019-03-18
author: G. Kuling
Simple implementation of ResNet for segmentation
Adapted from: https://github.com/danielelic/deep-segmentation/blob/master
/train_resnet.py
'''
...
def get_resnet(img_shape=(256, 256),
               f=16,
               bn_axis=3,
               num_classes=1,
               num_channels=1):
