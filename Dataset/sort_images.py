...
def sort_images(image_path_t2_t1, image_path_t2_flair, image_path_t2_t1ce, seg_path_main, destination):

    df = pd.DataFrame(columns=['volume_name',
                               't1_filename', 't1ce_filename', 't2_filename', 'flair_filename',
                               't1_file_path', 't1ce_file_path', 't2_file_path', 'flair_file_path',
    ...
    for image in os.listdir(image_path_t2_t1):
        ...
        t1ce_filename_new = volume_name + '_t1ce_' + slice_number + '.npy'
...
if __name__ == '__main__':
    ...
    image_path_t2_flair = 'D:/Geoff_Klein/BRATS18/T2_Flair'

    image_path_t2_t1 = 'D:/Geoff_Klein/BRATS18/T2_T1'
    image_path_t2_t1ce = 'D:/Geoff_Klein/BRATS18/T2_T1ce'

    seg_path_main = 'D:/Geoff_Klein/BRATS18/MICCAI_BraTS_2018_Data_Training/HGG'

    destination = 'D:/Geoff_Klein/BRATS18/Synth_T1ce'

    df = sort_images(image_path_t2_t1, image_path_t2_flair, image_path_t2_t1ce, seg_path_main, destination)
